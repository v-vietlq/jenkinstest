...
@section('title',__('module.title.user_create'))
            ...
            @card(['title' => 'module.card.information'])
                <div class="form-group">
                    ...
                    <select name="level" class="form-control">
                        <option value="1" {{ (old('level') == 1) ? 'selected' : '' }}>{{ __('form.user.admin') }}</option>
                        <option value="2" {{ (old('level') == 2) ? 'selected' : '' }}>{{ __('form.user.employer') }}</option>
                        <option value="3" {{ (old('level') == 3) ? 'selected' : '' }}>{{ __('form.user.member') }}</option>
                    </select>
                </div>
            ...
            @card(['title' => 'module.card.information_personal'])
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input  type="radio" class="form-check-input" name="gender" value="1" {{ (old('gender') == 1) ? 'checked' : '' }}> {{ __('form.user.male') }}
                        </label>
                    </div>

                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="gender" value="0" {{ (old('gender') == 0) ? 'checked' : '' }}> {{ __('form.user.female') }}                        
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" name="birthday" class="form-control daterange-single" value="{{ old('birthday') }}">
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="zalo_phone" class="form-control" value="{{ old('zalo_phone') }}" />
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="literacy" class="form-control">
                        <option value="1" {{ (old('literacy') == 1) ? 'selected' : '' }}>{{ __('form.user.junior_high_school') }}</option>
                        <option value="2" {{ (old('literacy') == 2) ? 'selected' : '' }}>{{ __('form.user.high_school') }}</option>
                        <option value="3" {{ (old('literacy') == 3) ? 'selected' : '' }}>{{ __('form.user.intermediate') }}</option>
                        <option value="4" {{ (old('literacy') == 4) ? 'selected' : '' }}>{{ __('form.user.college') }}</option>
                        <option value="5" {{ (old('literacy') == 5) ? 'selected' : '' }}>{{ __('form.user.university') }}</option>
                        <option value="6" {{ (old('literacy') == 6) ? 'selected' : '' }}>{{ __('form.user.after_university') }}</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="years_experience" class="form-control">
                        <option value="1" {{ (old('years_experience') == 1) ? 'selected' : '' }}>{{ __('form.user.less_than_a_year') }}</option>
                        <option value="2" {{ (old('years_experience') == 2) ? 'selected' : '' }}>{{ __('form.user.a_year') }}</option>
                        <option value="3" {{ (old('years_experience') == 3) ? 'selected' : '' }}>{{ __('form.user.two_year') }}</option>
                        <option value="4" {{ (old('years_experience') == 4) ? 'selected' : '' }}>{{ __('form.user.over_two_years') }}</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="years_experience" class="form-control">
                        <option value="1" {{ (old('marital_status') == 1) ? 'selected' : '' }}>{{ __('form.user.single') }}</option>
                        <option value="2" {{ (old('marital_status') == 2) ? 'selected' : '' }}>{{ __('form.user.married') }}</option>
                        <option value="3" {{ (old('marital_status') == 3) ? 'selected' : '' }}>{{ __('form.user.divorce') }}</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input  type="radio" class="form-check-input" name="driver_license" value="1" {{ (old('driver_license') == 1) ? 'checked' : '' }}> {{ __('form.user.yes') }}
                        </label>
                    </div>

                    <div class="form-check form-check-inline">
                        <label class="form-check-label">
                            <input type="radio" class="form-check-input" name="driver_license" value="0" {{ (old('driver_license') == 0) ? 'checked' : '' }}> {{ __('form.user.no') }}                        
                        </label>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="company_did" class="form-control" value="{{ old('company_did') }}" />
                </div>
                

                <div class="form-group">
                    <label>{{ __('form.user.position_did') }}: <span class="text-danger">*</span></label>
                    <input type="text" name="position_did" class="form-control" value="{{ old('position_did') }}" />
                </div>
            @endcard
        </div>
    </div>
